kawaii: game.o main.o hud.o movement.o player.o enemy.o world.o display.o texture.o textTexture.o tile.o camFocus.o collision.o collideBox.o entity.o background.o
	g++ game.o main.o hud.o movement.o player.o enemy.o world.o display.o texture.o textTexture.o tile.o camFocus.o collision.o collideBox.o entity.o background.o -w -lSDL2 -lSDL2_image -lSDL2_ttf -o kawaii
main.o: main.cpp game.h
	g++ -c main.cpp
display.o: display.cpp display.h 
	g++ -c display.cpp
game.o: game.cpp game.h hud.h movement.h player.h enemy.h display.h texture.h textTexture.h tile.h world.h camFocus.h collision.h background.h
	g++ -c game.cpp
hud.o: hud.cpp hud.h
	g++ -c hud.cpp
